...
import com.example.traficprocessor.adapter.persistence.dynamo.PersistenceDynamoTest;
...
@PersistenceDynamoTest
public class DynamoTrafficEventRepositoryTest {
  @Autowired private DynamoTrafficEventRepository repository;
